...
- Complete first part of LAB_4 (text2sql_agent). We will be include the openapi tool from the first part in the flow as well. If not, run the following command

## 2 — Import the agent and tools

1. cd to this directory: `LAB_3_TEXT2SQL_AGENT/text2sql_flow_agent`
